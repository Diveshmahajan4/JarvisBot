...
import { Message, ReviewPortfolioMessage } from "@/utils/classes/message";
...
import { USDC } from "@/utils/constants/coins";
import { MultiStrategy } from "@/utils/classes/strategies/multiStrategy";
import { getStrategy } from "@/utils/strategies";
import { useStrategy } from "@/hooks/useStrategy";

interface ReviewPortfolioBotWrapperProps {
  message: ReviewPortfolioMessage;
  addBotMessage: (message: Message) => Promise<void>;
}

const ReviewPortfolioBotWrapper: React.FC<ReviewPortfolioBotWrapperProps> = ({
  message,
  addBotMessage,
}) => {
...
export default ReviewPortfolioBotWrapper;
