...
import type { Message, PortfolioMessage } from "@/utils/classes/message";
...
interface PortfolioBotWrapperProps {
  message: PortfolioMessage;
  addBotMessage: (message: Message) => Promise<void>;
}

const PortfolioBotWrapper: React.FC<PortfolioBotWrapperProps> = ({
  message,
  addBotMessage,
}) => {
...
export default PortfolioBotWrapper;
