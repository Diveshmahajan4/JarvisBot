...
import { DepositMessage, Message } from "@/utils/classes/message";
...
interface DepositBotWrapperProps {
  message: DepositMessage;
  addBotMessage: (message: Message) => Promise<void>;
}

const DepositBotWrapper = ({
  message,
  addBotMessage,
}: DepositBotWrapperProps) => {
...
export default DepositBotWrapper;
