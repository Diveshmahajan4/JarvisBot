...
import type { StrategyMetadata } from "@/utils/types";
...
import { InvestMessage } from "@/utils/classes/message";

import type { Message } from "@/utils/classes/message";
interface InvestmentFormBotWrapperProps {
  message: InvestMessage;
  addBotMessage: (message: Message) => Promise<void>;
}

const InvestmentFormBotWrapper = ({
  message,
  addBotMessage,
}: InvestmentFormBotWrapperProps) => {
...
export default InvestmentFormBotWrapper;
