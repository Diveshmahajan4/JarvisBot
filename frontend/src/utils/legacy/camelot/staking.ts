...
import { CAMELOT_CONTRACTS } from "@/utils/constants/protocols";
import { XGRAIL_ABI, CAMELOT_STRATEGY_ABI } from "@/utils/constants/abis";
import { GRAIL, WETH, xGRAIL } from "@/utils/constants/coins";
